...
> ⚠️ **Nota:** El proyecto requiere el servidor activo para funcionar. No abras `index.html` directamente, ya que la autenticación y las sesiones se gestionan contra el backend.
